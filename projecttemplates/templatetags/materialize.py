...
@register.filter
def materialize(element, options={}):
...
def render(element, markup_classes):
    ...
    if element_type == 'boundfield':
        ...
        template = get_template("projecttemplates/field.html")
        ...
        if has_management:
            ...
            template = get_template("projecttemplates/formset.html")
            context = {'formset': element, 'classes': markup_classes, 'icon_set': icon_set}
        else:
            for field in element.visible_fields():
                add_input_classes(field)

            template = get_template("projecttemplates/form.html")
